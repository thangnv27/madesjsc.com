...
class Photo extends cat_tree{
	...
	public function _int(){
  	...
  	public function listPhoto(){
		...
		$sql = "SELECT * FROM ".$this->table." ORDER BY thu_tu DESC, ".$this->id_item." DESC";
	...
	public function addNew(){
		global $DB, $tpl, $lang,$dklang,$pid,$tree;
		$tpl->newBlock("addNew");	
		$info['parentid1']=$pid;
			$info['parentid'] .= '<select name="parentid" id="parentid" style="WIDTH: 220px" >';
