...
<form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        <td><strong>Giá trị 1</strong></td>
        <td><input type="text" name="giatri" value="{giatri}"/> <span style="font-style:italic">(Chỉ nhập số không có dấu "." hoặc dấu ",")</span></td>
      </tr>
      <tr>
        <td><strong>Giá trị 2</strong></td>
        <td><input type="text" name="giatri1" value="{giatri1}"/> <span style="font-style:italic">(Chỉ nhập số không có dấu "." hoặc dấu ",")</span> </td>
      </tr>
      <tr>
