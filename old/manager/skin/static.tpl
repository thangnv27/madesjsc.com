...
<form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        ...
        <td>
        	<label class="radio"><input name="inwhere" type="radio" value="incontact" {incontact}>Nội dung trên trang liên hệ</label>
            <label class="radio"><input name="inwhere" type="radio" value="infooter" {infooter}>Dòng bản quyền</label>
            <label class="radio"><input name="inwhere" type="radio" value="footer" {footer}>Chân trang</label>
        </td>
      </tr>
      <tr>
