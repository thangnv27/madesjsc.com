...
class TemplatePower extends TemplatePowerParser
{
  ...
  /**********
	...
	public function printToScreen1()
    {
        if ($this->prepared) {
            $this->__outputContent(TP_ROOTBLOCK . '_0');
        } else {
	...
	public function outHtmlMinify(){
		
		$html = $this->getOutputContent ();
		echo $this->replace_tabs_newlines($html);	
	}
	
	public function replace_tabs_newlines($content) {
