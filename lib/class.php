...
defined( '_VALID_NVB' ) or die( 'Direct Access to this location is not allowed.' );
  	...
  	class paging{
		...
		{ 
			...
			global $DB, $tpl, $lang,$site_address,$LANG;
				...
				if ($showpage<=$total) { 
					...
					if ($p==$showpage) { 
						...
						if($showpage<=1){
							...
							$list_page.="<a href='".$url."' class='page' >&nbsp;".$showpage."&nbsp;</a>"; 

						}else{

							$list_page.="<a href='".$url."page-".$showpage."/' class='page' >&nbsp;".$showpage."&nbsp;</a>"; 
			...
			if ($num_page>1) { 
				...
				if ($num_page>2) { 
					...
					$list_page1="<a href='".$url."page-"."1/' class='page' ><strong>|<</strong></a>"; 

				} 

				$list_page1.="<a href='$url"."page-"."/' class='page' ><strong><<</strong></a>"; 
			...
			if ($num_page<ceil($total/$maxpage)&&($total>$maxpage)) { 
				...
				$list_page2.=" <a href='".$url."page-".$next."/'  class='page'><strong>>></strong></a>"; 

				$list_page2.=" <a href='".$url."page-".$total."/'  class='page'><strong>>>|</strong></a>"; 
		...
		{ 
			...
			{ 
				...
				if ($showpage<=$total) { 
					...
					if ($p==$showpage) { 
						...
						$list_page.="<a href='".$url."&$p1=".$showpage."' class='page' >&nbsp;".$showpage."&nbsp;</a>"; 
			...
			if ($num_page>1) { 
				...
				if ($num_page>2) { 
					...
					$list_page1="<a href='".$url."&$p1="."1' class='page' ><strong>|<</strong></a>"; 

				} 

				$list_page1.="<a href='$url"."&$p1="."' class='page' ><strong><<</strong></a>"; 
			...
			if ($num_page<ceil($total/$maxpage)&&($total>$maxpage)) { 
				...
				$list_page2.=" <a href='".$url."&$p1=".$next."'  class='page'><strong>>></strong></a>"; 

				$list_page2.=" <a href='".$url."&$p1=".$total."'  class='page'><strong>>>|</strong></a>"; 
		...
		public function Editor($id,$value){
			...
			$config['toolbar'] = array(
				...
				'-','JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock','-','BidiLtr','BidiRtl',
				 ...
				 'links',  'Link','Unlink','Anchor' ,'MediaEmbed','insertvideo' ),
...
class cat_tree{
...

	{
		...
		global $DB,$tree,$language; // add $cat_old
		...
		$sql = "SELECT * FROM category WHERE parentid='$parent' $language $dataType ORDER BY thu_tu ASC,id_category DESC";
	...
	function get_cat_tree1($parent = 0,$data_type='')

	{

		global $DB,$tree1,$language; // add $cat_old
		...
		/*
			...
			*/
			...
			$this->get_cat_tree1($result['id_category'],$data_type);
...
class Category{
  	...
  	public function getParentId($idc,$data_type=''){
		...
		if($data_type!='') $dtt = " AND data_type ='".$data_type."' ";
