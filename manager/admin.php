...
<script language="javascript">$(document).ready(function(){$('#username').focus();	});function check_null_login_binh(){if($('#username').val()==''){$('#alert').html('<div class="alert alert-error">Bạn phải nhập vào tên đăng nhập !</div>');$('#username').focus();return false;}if($('#password').val()==''){$('#alert').html('<div class="alert alert-error">Bạn phải nhập vào mật khẩu đăng nhập !</div>');$('#password').focus();return false;}}</script>
</body>
</html>
<?php 
}
