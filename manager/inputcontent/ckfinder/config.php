...
function CheckAuthentication()
{
	...
	if(isset($_SESSION['IsAuthorized']) && $_SESSION['IsAuthorized']=='binhnv'){
		return true;	
	}else{
		return false;
	}
...
$config['plugin_imageresize']['mediumThumb'] = '90x90';
$config['plugin_imageresize']['largeThumb'] = '90x90';
