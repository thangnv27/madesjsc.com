...
<form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        <td><strong>Số sản phẩm/1 mục/cột phải</strong></td>
        <td><input name="setting[productinboxright]" type="text" style="width:100px;" value="{productinboxright}"></td>
      </tr>
      ...
      <tr>
        <td><strong>Gọi ngay</strong></td>
        <td><input name="setting[callnow]" type="text" style="width:300px;" value="{callnow}"> <i style="font-size:11px; color:#666">Chỉ điền 1 số điện thoại</i></td>
      </tr>
      <tr>
