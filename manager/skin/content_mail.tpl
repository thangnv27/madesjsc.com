  ...
  <form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        ...
        <td>
          <label class="radio">
            <input name="inwhere" type="radio" value="replaymailorder" {replaymailorder}>
            Nội dung trả lời mail đặt hàng</label>
          <label class="radio">
            <input name="inwhere" type="radio" value="mailbill" {mailbill}>
            Nội dung mail tình trạng đơn hàng</label>
        </td>
      </tr>
      <tr >
      ...
      <tr>
        <td><strong>Chèn thông tin khách hàng</strong></td>
        <td>
          <div class="customerinfo"> <a href="#" rel="[hoten]"  title="Click chèn">Họ tên</a>| <a href="#" rel="[dienthoai]"  title="Click chèn">Điện thoại</a>| <a href="#" rel="[diachi]" title="Click chèn">Địa chỉ</a>| <a href="#" rel="[email]" title="Click chèn">Email</a>| <a href="#" rel="[yeucau]" title="Click chèn">Yêu cầu</a>| <a href="#" rel="[giohang]" title="Click chèn">Giỏ hàng</a> | <a href="#" rel="[bill]" title="Click chèn">Số bill</a></div>
          <script>
			$(function(){
				$('.customerinfo a').click(function(){
					CKEDITOR.instances.content.insertHtml( $(this).attr('rel') );	
					return false;
				});
			});
            </script> 
