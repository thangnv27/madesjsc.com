...
<form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        ...
        <td><input type="text" name="thoigian" id="thoigian" class="txtform100" value="{thoigian}" /></td>
      </tr>
      <tr>
        <td><strong>Khai giảng</strong></td>
        <td><input type="text" name="khaigiang" id="title" class="txtform100" value="{khaigiang}" /></td>
      </tr>
      <tr>
        <td><strong>Học phí</strong></td>
        <td><input type="text" name="hocphi" id="hocphi" class="txtform100" value="{hocphi}" /></td>
      </tr>
      <tr>
