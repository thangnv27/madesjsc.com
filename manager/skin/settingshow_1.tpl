	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        ...
        <td><input name="setting[btn_doitra_detail_pro]" type="text" style="width:300px;" value="{btn_doitra_detail_pro}"></td>
   	     ...
   	     <tr>
        <td><strong>Thông tin chung (Sp chi tiết)</strong></td>
        <td><textarea name="setting[generaldetailpro]" type="text" style="width:400px;" rows="5" >{generaldetailpro}</textarea></td>
      </tr>
      <tr>
        <td><strong>ĐT - Địa chỉ (Sp chi tiết)</strong></td>
        <td><textarea name="setting[phoneaddress]" type="text" style="width:400px;" rows="5" >{phoneaddress}</textarea></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><textarea name="setting[page404]" style="width:400px;" rows="5">{page404}</textarea></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
