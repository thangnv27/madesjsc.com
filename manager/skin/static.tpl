...
<form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        ...
        <th colspan="2"><i class="icon-pencil icon-white"></i>&nbsp;Nôi dung tĩnh</th>
      ...
      <tr>
        ...
        <td valign="top"><strong>Kiểu dữ liệu</strong></td>

        <td>
            <label class="radio"><input name="inwhere" type="radio" value="vanchuyen" {vanchuyen}>Vận chuyển (Dưới sản phẩm chi tiết)</label>
            <label class="radio"><input name="inwhere" type="radio" value="thanhtoan" {thanhtoan}>Thanh toán (Dưới sản phẩm chi tiết)</label>
            <label class="radio"><input name="inwhere" type="radio" value="doitra" {doitra}>Đổi trả hàng (Dưới sản phẩm chi tiết)</label>
            <label class="radio"><input name="inwhere" type="radio" value="copyright" {copyright}>Copyright</label>
            <label class="radio"><input name="inwhere" type="radio" value="fanpage" {fanpage}>Fanpage facebook</label>
            <label class="radio"><input name="inwhere" type="radio" value="muahangtuxa" {muahangtuxa}>Địa chỉ (sản phẩm chi tiết)</label>
            <label class="radio"><input name="inwhere" type="radio" value="generalproduct" {generalproduct}>Thông tin chung (sản phẩm chi tiết)</label>
            <label class="radio"><input name="inwhere" type="radio" value="page404" {page404}>Page 404</label>
             <label class="radio"><input name="inwhere" type="radio" value="hdmuahang" {hdmuahang}>HD mua hàng (Menu fix top)</label>
              <label class="radio"><input name="inwhere" type="radio" value="chantrang1" {chantrang1}>Chân trang 1</label>
              <label class="radio"><input name="inwhere" type="radio" value="chantrang2" {chantrang2}>Chân trang 2</label>
        </td>
      </tr>
